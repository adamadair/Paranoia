...
{
    /// <summary>
    /// An excellent random number generator that is predictable. If predictability is
    /// a requirement then System.Random can not be used because it is not
    /// guaranteed to generate the same sequence of numbers for a given seed acrosss 
    /// different versions of the .NET framework. This one will.
    /// 
    /// This pseudo-random number generator based on the Mersenne Twister number 
    /// generator developed by Tukuji Nishimura and Makoto Matsumoto.
    ...
    public class MTRandom : System.Random
    {
        ...
        public MTRandom()
            : this(System.Convert.ToUInt32(DateTime.Now.Ticks % uint.MaxValue)) /* a default initial seed is used   */
        {
